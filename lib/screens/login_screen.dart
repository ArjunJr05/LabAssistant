                                    ...
                                    children: [
                                      ...
                                      if (_isLogin || !widget.isAdminMode) ...[
                                        ...
                                        _buildTextField(
                                          ...
                                          label: 'Password',
                                          icon: Icons.lock,
                                          hint: widget.isAdminMode ? 'Admin_dept@clg' : null,
  ...
  Future<void> _handleSubmit() async {
    ...
    if (widget.isAdminMode && _isLogin) {
      ...
      if (success && mounted) {
        ...
        // Login failed - show error and don't navigate
    ...
    if (!success && mounted) {
      ...
      // Check if there's a specific error message from the auth service (e.g., account locked)
      final specificError = authService.loginErrorMessage;
      
      if (specificError != null && specificError.contains('locked')) {
        // Account is locked - show specific error
        errorMessage = specificError;
      } else if (widget.isAdminMode && !_isLogin) {
        errorMessage = 'Admin registration failed. Check master password and try again.';
      } else if (_isLogin) {
        errorMessage = specificError ?? 'Login failed. Check your credentials and try again.';
      } else {
