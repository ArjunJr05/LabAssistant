...
if (user.is_locked === true) {
  console.log('🔒 Student account is locked:', enrollNumber);
  return res.status(403).json({ 
    message: 'Your account has been locked due to suspicious activity. Please contact the administrator.',
    isLocked: true,
    tabSwitchCount: user.tab_switch_count,
